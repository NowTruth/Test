...
///*
//課題３
//ゴールと同じ数字でないとゴールできず、超えてしまった分は戻るよう修正してください。
// */
//
///**
// * プレイヤークラス
...
// * @author ryo
// */
//public class SugorokuAnswer3Rev1 {
//
...
//			SugorokuAnswer3Rev1 sugo = new SugorokuAnswer3Rev1();
//
...
//				back = 2 * (GOAL - playerList.get(i).getNum());
//				playerList.get(i).addNum(back);
//				System.out.println(playerList.get(i).getName() + " は " + playerList.get(i).getNum() + " まで戻りました ");
//
//				//戻った結果進んだマス数が0以下の場合には、0とする
//				if (playerList.get(i).getNum() < 0) {
//					playerList.get(i).addNum(0);
//				}
//			}
//
//			//進んだマス数がゴールマスなら終了する
