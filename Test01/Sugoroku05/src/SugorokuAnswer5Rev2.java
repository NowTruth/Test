 ...
 *
 */
public class SugorokuAnswer5Rev2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			while (true) {
				...
				SugorokuAnswer5Rev2 sugo = new SugorokuAnswer5Rev2();
				...
				//すごろくを再プレイするかを聞く
				System.out.println("再度プレイをする場合は、0を入力してください。");
				System.out.println("終了する場合は、1を入力してください。");

				//再プレイ確認をキーボードより入力する
				input = br.readLine();
				//キーボードから入力された再プレイ確認をint型に変換する
				isEnd = Integer.parseInt(input);
